...
echo "  namespace: jenkins" >> ./manifests/prometheus/prometheus-rules.yaml
...
# Workaround since `--namespace monitoring` from above is not preserved
echo "  namespace: jenkins" >> ./manifests/alertmanager/alertmanager-templates.yaml
...
# Workaround since `--namespace monitoring` from above is not preserved
echo "  namespace: jenkins" >> ./manifests/grafana/import-dashboards/configmap.yaml
...
# Workaround since `--namespace monitoring` from above is not preserved
echo "  namespace: jenkins" >> ./manifests/prometheus/configmap.yaml
